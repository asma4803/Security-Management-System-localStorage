    ...
    <head>
        ...
        <script>
            function Main()
            {
                ...
                //var UpdatedUserArray = SecurityManager.GetAllRoles();
                var table = document.getElementById("data");

                var headingRow = document.createElement("tr");

                headingRow.innerHTML = "<tr>  <th>ID</th> <th>Role</th>  <th>Description</th><th>Edit</th><th>Delete</th></tr>";
                table.appendChild(headingRow);
                var dataArray = SecurityManager.GetAllRoles();

                for (var i = 0; i < dataArray.length; i++)
                {
                    var row = document.createElement("tr");
                    row.innerHTML = "<td >" + dataArray[i].ID + "</td><td>" + dataArray[i].role + "</td><td>" + dataArray[i].description + "</td><td><input type='submit' value='edit' onclick='edit(this);'></td><td><input type='submit' value='delete' onclick='remove(this);'></td> ";
                ...
                saveBtn.onclick = function () {
                    ...
                    if (flag1 == true && flag3 == true) {
                        var roleObj = {"role": role, "description": description};
                        //console.log(user);
                        ...
                        row1.innerHTML = "<td>" + roleObj.ID + "</td><td>" + roleObj.role + "</td><td>" + roleObj.description + "</td><td><input type='submit' value='edit' onclick='edit(this);'> </td><td><input type='submit' value='delete' onclick='remove(this);'> </td>";
                        table.appendChild(row1);

                    }
                    if (flag1 == false) {
                        var div = document.getElementById("rdiv");
                        div.innerText = "role already exists";
                ...
                for (var k in roleArray)
                {
                    ...
                    if (id == roleArray[k].ID) {
                        ...
                        save.onclick = function () {
                            ...
                            role.description = document.getElementById("description").value;

                            debugger;
                            if (role.role == "" || role.description == "") {
                                flag3 = false;

                            }
                            for (var h in roleArray) {
                                if (roleArray[h].role == role.role && roleArray[h].ID != id)
                                {
                                    flag1 = false;
                                }
                            ...
                            if (flag1 == true && flag3 == true) {
                                SecurityManager.SaveRole(role, function () {
                                    alert("role updated");
                                }, function () {
                                    alert("some problem occured");
                                });
            ...
            function remove(element) {
                ...
                if (result) {
                    ...
                    debugger;
                    for (var l in roleArray)
                    {
                        //console.log(userArray[k]);
                        if (roleArray[l].ID == id) {

                            SecurityManager.DeleteRole(id, function () {
            ...
            function rempty() {
                ...
                {
                    document.getElementById("rdiv").innerText = "enter role";
                } else
                {
                    document.getElementById("rdiv").innerText = "";
                }
            }
            function dempty() {
                ...
                <tr>
                    <td style="width:400px">
                        <div id="div2" class="login-box animated fadeInUp">
                            ...
                            <br/>
                            <input type="text" id="role" onblur="rempty();"><div id="rdiv" style="color:saddlebrown"> </div>
                            <br/>
